...
set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_visual_grey2,bg=$onedark_black]#[fg=$onedark_visual_grey2,bg=$onedark_visual_grey2]#[fg=$onedark_white, bg=$onedark_visual_grey2]${status_widgets} #[fg=$onedark_green,bg=$onedark_visual_grey2,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_green,bold] #h #[fg=$onedark_yellow, bg=$onedark_green]#[fg=$onedark_red,bg=$onedark_yellow]"
...
set "window-status-current-format" "#[fg=$onedark_black,bg=$onedark_visual_grey2,nobold,nounderscore,noitalics]#[fg=$onedark_white,bg=$onedark_visual_grey2,nobold] #I  #W #[fg=$onedark_visual_grey2,bg=$onedark_black,nobold,nounderscore,noitalics]"
